                ...
                <div id="tab-1" class="tab-contents current">
                    <form action="loginquery.php" method="post">
                        ...
                        <div class="today-para">
                            ...
                            <input type="text" placeholder="Enter a Mail-id" name="email" class="form-control">
                        </div>
                        <div  class="today-para">
                           
                            <input type="number" placeholder="+91 Mobile Number" name="phone_number" class="form-control">
                        </div>
                        <div class="term-btn">
                            <button type="submit" name="submit" class="form-control">Login</button>
                        </div>
                        <div  class="quotes-para">
                            <p>By clicking on <a href="register.php"> Register </a> Or <a href=""> Forget the Password</a>
                            </p>
                        </div>
                    </form>
